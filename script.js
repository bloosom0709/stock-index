...
var videoURL_array=[];
videoURL_array[0]='<iframe class="video_URL" frameborder="0" src="https://youtu.be/nleb65x1dFM" allowfullscreen="true"></iframe>'
videoURL_array[1]='<iframe class="video_URL" frameborder="0" src="https://youtu.be/fy-ZjVTzHtY" allowfullscreen="true"></iframe>'
videoURL_array[2]='<iframe class="video_URL" frameborder="0" src="https://youtu.be/aEYBo3VXU78" allowfullscreen="true"></iframe>'
videoURL_array[3]='<iframe class="video_URL" frameborder="0" src="https://youtu.be/4p8L2f8OXls" allowfullscreen="true"></iframe>'
videoURL_array[4]='<iframe class="video_URL" frameborder="0" src="https://youtu.be/Hmu5b_hZIAU" allowfullscreen="true"></iframe>'
...
videoURL_array[6]='<iframe class="video_URL" frameborder="0" src="https://youtu.be/lDhG1nfGVcE" allowfullscreen="true"></iframe>'
