...
videoTitle_array[0]="投資策略1_ 什麼是投資策略？"
videoTitle_array[1]="投資策略2_ 投資策略搭配的指標？"
videoTitle_array[2]="股票名詞1_ 股本、EPS"
videoTitle_array[3]="股票名詞2_殖利率、本益比"
videoTitle_array[4]="股票名詞3_ROA、ROE"
videoTitle_array[5]="股票名詞4_ K線"
videoTitle_array[6]="股票名詞5_ 均線"
...
videointro_array[5]="透過K棒可以了解一天股價的最高、最低、開盤、收盤4個價格，紅K代表今天股價上升，綠K則代表股價下跌，但建議搭配均線觀看，才能進一步預測趨勢喔！"
videointro_array[6]="移動平均線簡稱為均線或是 MA或T，紀錄著一段時間的「平均」股價，分成短日、長日均線，可以用來判斷股價上漲或是下跌的趨勢喔！"

var videoURL_array=[];
videoURL_array[0]='<iframe class="video_URL" frameborder="0" src="https://www.youtube.com/embed/nleb65x1dFM" allowfullscreen="true"></iframe>'
videoURL_array[1]='<iframe class="video_URL" frameborder="0" src="https://www.youtube.com/embed/fy-ZjVTzHtY" allowfullscreen="true"></iframe>'
videoURL_array[2]='<iframe class="video_URL" frameborder="0" src="https://www.youtube.com/embed/aEYBo3VXU78" allowfullscreen="true"></iframe>'
videoURL_array[3]='<iframe class="video_URL" frameborder="0" src="https://www.youtube.com/embed/4p8L2f8OXls" allowfullscreen="true"></iframe>'
videoURL_array[4]='<iframe class="video_URL" frameborder="0" src="https://www.youtube.com/embed/Hmu5b_hZIAU" allowfullscreen="true"></iframe>'
videoURL_array[5]='<iframe class="video_URL" frameborder="0" src="https://www.youtube.com/embed/lDhG1nfGVcE" allowfullscreen="true"></iframe>'
videoURL_array[6]='<iframe class="video_URL" frameborder="0" src="https://www.youtube.com/embed/VsS6LZUrZ5I" allowfullscreen="true"></iframe>'
